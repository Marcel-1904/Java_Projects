...
// the application is written to offer a menu to make working with the
//software easier and user friendly

/**
 * @author Marcel Deetlefs
 * @version 1.00 13 January 2022
 * 
 * 
...
public class CapstoneProject3
{
	...
	
	{
		...
		// loads project saved data if there is any saved data
		try 
		{
		...
		// loads project settings if there is any saved
		try 
		{
